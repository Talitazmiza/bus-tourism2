...
const AddFleet = () => {
    return (
        <div>
            {/*@ts-ignore*/}
            <button className="btn hover:bg-blue-400 rounded-full p-2" onClick={()=>document.getElementById('my_modal_1').showModal()}>
                <FontAwesomeIcon icon={faPlus} /> Tambah Armada</button>
            <dialog id="my_modal_1" className="modal rounded-lg">
                <div>
                    <div className="modal-box">
                        <h3 className="font-bold text-lg">Tambah Armada</h3>
                        ...
                        <div className="modal-action p-10">
                            <form method="dialog">
                                ...
                                <div className="flex justify-between mt-5">
                                    ...
                                    <button className="btn bg-blue-500 font-bold rounded-full p-5">Tambah</button>
                                </div>
                            </form>
                        </div>
                    </div>
