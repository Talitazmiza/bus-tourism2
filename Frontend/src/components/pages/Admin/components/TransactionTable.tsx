...
import AddTransactionPopUp from "../Transaction/AddTransactionPopUp.tsx";
import UpdateTransactionPopUp from "../Transaction/UpdateTransactionPopUp.tsx";
                                            ...
                                            <div className="relative p-4 w-full max-w-md max-h-full">
                                                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div className="p-4 md:p-5 text-center">
                                                        ...
                                                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda yakin ingin menghapus transaksi ini?</h3>
