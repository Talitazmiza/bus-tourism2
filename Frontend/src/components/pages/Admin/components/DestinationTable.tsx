...
import AddDestPopUp from "../Destination/AddDestPopUp.tsx";
import SearchBar from "../organs/SearchBar.tsx";
import UpdateDestPopUp from "../Destination/UpdateDestPopUp.tsx";
...
const rows = [
    ...
    createData('2','Bandung', 'img', 900000, 2),
    createData('3','Surabaya', 'img', 160000, 1),
    createData('4','Malang', 'img', 370000, 0),
    createData('5','Banyuwangi', 'img', 160000, 1),
];
                ...
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="right">Estimasi Harga (Rp)</TableCell>
                            <TableCell align="right">Estimasi Trip (Hari)</TableCell>
                                            ...
                                            <div className="relative p-4 w-full max-w-md max-h-full">
                                                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div className="p-4 md:p-5 text-center">
                                                        ...
                                                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda yakin ingin menghapus Destinasi ini?</h3>
