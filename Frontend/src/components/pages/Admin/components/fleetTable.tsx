                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="grid grid-cols-5 rounded-sm bg-white dark:bg-meta-4 sm:grid-cols-6">
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <img src="https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/BS%20VI%20Bus%20Single%20Axcel_Single%20Bus?wid=1400&fit=constrain" className="w-30 h-20"/>
                            </div>
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                        ...
                        <div className="grid grid-cols-5 rounded-sm bg-white dark:bg-meta-4 sm:grid-cols-6">
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <img src="https://media.istockphoto.com/id/135327019/photo/white-passenger-bus.jpg?s=612x612&w=0&k=20&c=sRU5BpOsY6fyYj9pMiAxz0dLML--uoNl7rIXelRbFnc=" className="w-30 h-20"/>
                            </div>
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <p className="hidden font-medium text-black sm:block">
                        ...
                        <div className="grid grid-cols-5 rounded-sm bg-white dark:bg-meta-4 sm:grid-cols-6">
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <img src="https://en.higer.com/uploadfiles/2021/01/20210114153659283.png?Njg5Ni5wbmc=" className="w-30 h-20"/>
                            </div>
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <p className="hidden font-medium text-black sm:block">
                                    Super Top
                        ...
                        <div className="grid grid-cols-5 rounded-sm bg-white dark:bg-meta-4 sm:grid-cols-6">
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <img src="https://en.higer.com/uploadfiles/2021/01/20210114084446496.png?NjEyMkIucG5n" className="w-30 h-20"/>
                            </div>
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <p className="hidden font-medium text-black sm:block">
                                    Normal Decker
                        ...
                        <div className="grid grid-cols-5 rounded-sm bg-white dark:bg-meta-4 sm:grid-cols-6">
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <img src="https://img.freepik.com/free-vector/cartoon-school-bus-white-background_1308-132853.jpg" className="w-30 h-20"/>
                            </div>
                            <div className="flex items-center gap-3 p-2.5 xl:p-5">
                                <p className="hidden font-medium text-black sm:block">
                                    Super Top
